...
public class GeneralAdapter extends RecyclerView.Adapter<GeneralAdapter.ViewHolder> {
  ...
  public GeneralAdapter(Context mContext, List<Article> articles) {
    this.articles = articles;
    this.mContext = mContext;
  }
    @Override public GeneralAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
    ...
    @Override public void onBindViewHolder(GeneralAdapter.ViewHolder viewHolder, int position) {
