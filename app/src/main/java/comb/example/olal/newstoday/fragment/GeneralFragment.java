...
import comb.example.olal.newstoday.model.GeneralAdapter;
...
public class GeneralFragment extends Fragment {
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    recyclerView = (RecyclerView) view.findViewById(R.id.general_card_recycler_view);
    adapter = new GeneralAdapter(getContext(), datalist);
    loadJSON();
    return view;
  }
  ...
  private void loadJSON(){
    ...
    Call<JSONResponse> call = apiInterface.getGeneralSources();
